 ...
 * Но в этом случае каждый объект класса Log4File будет содержать свои данные. Чтобы этого избежать:
 ...
 * 4. Как дать на объект ссылку? - Мы будем использовать "static" - его можно исп-ть для полей класса.
 * Как мы знаем, ключ слово "static" обозначает привязку к классу, а не к объекту.
 */
