...
public class ValidateInput implements Input {
    ...
    public int askInt(String question) {
        ...
        do {
             ...
             * В нашем случае мы сначала вводим значение с консоли, потом
             * проверяем его, что оно не содержит буквенных
             * символов и потом передаем его в метод parseInt(), который
