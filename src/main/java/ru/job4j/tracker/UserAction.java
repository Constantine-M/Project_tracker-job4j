...
public interface UserAction {
    ...
    /**
     * Метод execute возвращает boolean переменная. Это нужно,
     * чтобы создать действия выхода из программы.
     * @param input переменная интерфейса Input (определяет
     *              работу класса по получению данных от пользователя в консоли.)
