package ru.job4j.course.stream.flatmap;
...
public class UsageFlatMap {
     ...
     * Arrays.stream используется для примитивных типов
     * (int[], long[], and double[]) - в остальных случаях
     * лучше использовать Stream.of().
