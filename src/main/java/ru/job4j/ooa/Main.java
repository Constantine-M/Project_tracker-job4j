 ...
 * после изменим внутренне состояние созданного объекта и выведем в консоль объект до и после изменения
 */
public class Main {
    public static void main(String[] args) {
        /**Если мы объявляем константу на уровне класса, то обычно пишут вот так (ниже составное имя):*/
