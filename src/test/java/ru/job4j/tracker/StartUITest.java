...
public class StartUITest {
     ...
     * эмулируем ввод пользователя. То есть именно в таком порядке он
     * будет выбирать пункт (создание),
     ...
     * (in, tracker, actions), которые описывают ввод, методы над заявками
